...
| **7458 Chip** | [`7458_chip.sv`](./Verilog_Language/Basics/7458_chip.sv) | <img src="./Verilog_Language/Basics/img/7459_chip.png" width="200"> |
...
*Note: Additional vector exercises without graphical schematics (`vector4.sv`, `vector5.sv`) are also included in the source folder.*

---
> *"Hardware design is about translating logic into physical reality. These exercises lay the groundwork for my larger CPU and accelerator projects."*
